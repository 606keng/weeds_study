...
class TestReservePrice(object):
    ...
    @pytest.mark.parametrize(["purchasePrice", "actualAmount", "cardYear", "reservePriceLower", "reservePriceHeight"], [
        ...
        ("50000", "49900", "2017-01-01", "{}".format(dispose_num_up(50000*rate)), "{}".format(dispose_num_down(50000*year_0_3_price_5_8))),
    ...
    @pytest.mark.parametrize(["purchasePrice", "actualAmount", "cardYear", "reservePriceLower", "reservePriceHeight"], [
        ...
        ("129000", "10000", "2010-01-01", "{}".format(dispose_num_up(129000*rate)), "{}".format(dispose_num_down(129000*year_6_10_price_8_13))),

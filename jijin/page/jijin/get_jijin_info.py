...
class GetInfo(Web):
    ...
    def get_list_info(self):
        ...
        for i in range(8,11):
            ...
            ele1.send_keys(i + 2)
            self._driver.find_element_by_xpath('//*[@id="pgo_12"]').click()
            sleep(3)
            num = len(self._driver.find_elements_by_xpath('//*[@id="tblite_zs"]/tbody/tr/td[2]/a'))
            for i in range(num):
                jijin_info = {}
                ele = self._driver.find_elements_by_xpath('//*[@id="tblite_zs"]/tbody/tr/td[2]/a')[i]
                jijin_info["name"] = ele.text
                jijin_info["number"] = self._driver.find_elements_by_xpath('//*[@id="tblite_zs"]/tbody/tr/td[1]')[
                    i].text
                ele.click()
                ...
                jijin_info['last_week_rarking'] = \
                    self.scroll_find('//*[@id="increaseAmount_stage"]/table/tbody/tr[7]/td[2]/h3')[0]
                jijin_info['last_month_rarking'] = \
                    self.scroll_find('//*[@id="increaseAmount_stage"]/table/tbody/tr[7]/td[3]/h3')[0]
                jijin_info['three_month_rarking'] = \
                    self.scroll_find('//*[@id="increaseAmount_stage"]/table/tbody/tr[7]/td[4]/h3')[0]
                jijin_info['six_month_rarking'] = \
                    self.scroll_find('//*[@id="increaseAmount_stage"]/table/tbody/tr[7]/td[5]/h3')[0]
                jijin_info['this_year_rarking'] = \
                    self.scroll_find('//*[@id="increaseAmount_stage"]/table/tbody/tr[7]/td[6]/h3')[0]
                jijin_info['last_year_rarking'] = \
                    self.scroll_find('//*[@id="increaseAmount_stage"]/table/tbody/tr[7]/td[7]/h3')[0]
                jijin_info['two_year_rarking'] = \
                    self.scroll_find('//*[@id="increaseAmount_stage"]/table/tbody/tr[7]/td[8]/h3')[0]
                jijin_info['three_year_rarking'] = \
                    self.scroll_find('//*[@id="increaseAmount_stage"]/table/tbody/tr[7]/td[9]/h3')[0]
                print(jijin_info)

...
# 相当于wrappedClass=decorate("我爱你")(wrappedClass),即wrappedClass = decorateFunction(wrappedClass),即wrappedClass=wrapClass
@decorate("我爱你")
class wrappedClass:
    def __init__(self, *a, **k):
        print("我是被装饰类的构造方法")
